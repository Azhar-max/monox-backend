...
const getApiUrl = () => {
  // In production/build environment, VITE_* variables are statically replaced
  // In development, we can access them directly
  // In test environment, we use process.env
  
  // Try to access the variable directly (this works in Vite dev and build)
  try {
